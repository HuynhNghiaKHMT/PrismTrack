...
class Exp(MyExp):
    def __init__(self):
        ...
        self.width = 1.25
        self.exp_name = 'mot20'
        # self.train_ann = "jsons/mot20_train.json"
        # self.val_ann = "jsons/mot20_test.json"
        self.train_ann = os.path.join(YOLOX_ROOT, "jsons", "mot20_train.json")
        self.val_ann = os.path.join(YOLOX_ROOT, "jsons", "mot20_test.json")
