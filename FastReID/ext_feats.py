...
if __name__ == "__main__":
    ...
    args.config_path = f"FastReID/configs/{args.dataset}{half}/sbs_S50.yml"

    args.weight_path = f"FastReID/weights/{dataset}{half}_sbs_S50.pth"
    # ====================================================================
    ...
    for vid_name in detections.keys():
        for frame_id in detections[vid_name].keys():
            ...
            # Logging
            if frame_id % 100 == 0: # bổ sung để log tiến độ
