...
import random
import time
from newtrack_tcm.tracker import Tracker
...
def make_parser():
    ...
    parser.add_argument("--kf", type=str, default="new")   # old / new
    ...
    parser.add_argument("--tai_thr", type=float, default=0.8)
