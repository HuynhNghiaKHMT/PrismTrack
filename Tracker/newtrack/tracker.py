...
class Tracker(object):
    ...
    def update(self, dets, use_cmc, use_idcboost, use_reid, use_tpa):
        ...
        if use_idcboost:
            dets = IDCBoost(dets, self.tracks,  self.args.dlo_boost_coef, self.args.det_thresh, self.args.iou_limit,
        ...
        if not use_tpa:
            ...
            cost = build_cost_stage12(tracked_lost, dets_high, dets_low, self.args.penalty_p, self.frame_id, use_reid)
        ...
        if not use_tpa:
            ...
            cost = build_cost_stage12(final_tracks, dets_high_remain, [], 0.0, self.frame_id, use_reid)
            matches3, u_tracks3, u_dets3  = iterative_assignment(
                cost, self.args.match_thr, self.args.reduce_step, 
                final_tracks, dets_high_remain)
